...
# Page configuration
st.set_page_config(
    page_title="MCP Business Intelligence Assistant",
    page_icon="📊",
    layout="wide",
...
def generate_comprehensive_context(user_query: str = ""):
    ...
    You are a business intelligence assistant with access to comprehensive business data including:
...
def main():
    ...
    if any([st.session_state.reviews_data is not None,
        ...
        st.markdown("""
        ## 🚀 Welcome to Business Intelligence Assistant!
