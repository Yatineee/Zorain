...
# Page configuration
st.set_page_config(
    page_title="MCP AIcumen Assistant",
    page_icon="📊",
    layout="wide",
...
def generate_comprehensive_context(user_query: str = ""):
    ...
    You are a AIcumen Assistant with access to comprehensive business data including:
...
def main():
    # Main header
    st.markdown('<h1 class="main-header">📊 AIcumen Assistant</h1>', unsafe_allow_html=True)
...
def business_chat_interface():
    ...
    with st.expander("💡 Example Questions"):
        ...
        **Sales Analysis:**
        - "What's the sales volume for product XYZ?"
